 ...
 *
 */
public class GetPosMasterKey extends ClientReqHandle implements
	...
	public LocalResp verifyMessage(HashMap<String, String> map) {
		...
		if (map.get(ParseCoreReceiveXml.DEVICE_TYPE) == null || map.get(ParseCoreReceiveXml.DEVICE_TYPE).trim().length() == 0) {
			i++;
			sb.append(ParseCoreReceiveXml.DEVICE_TYPE + ",");
		}
