 ...
 *
 */
public class JFPalCardPaySDK extends ClientReqHandle implements
	...
	public LocalResp verifyMessage(HashMap<String, String> map) {
		...
		if (map.get(ParseCoreReceiveXml.PARTNER_ID) == null
				|| map.get(ParseCoreReceiveXml.PARTNER_ID).trim()
						.length() == 0) {
			i++;
			sb.append(ParseCoreReceiveXml.PARTNER_ID + ",");
		}
