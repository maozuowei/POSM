...
public class BankCardQuery extends ClientReqHandle implements IClientReqHandleService {
	...
	public CommunicationInfo getCommuInfo(HashMap<String, String> map) {
		...
		String parameter = ParseCoreReceiveXml.CARD_NO + "=" + map.get(ParseCoreReceiveXml.CARD_NO);
