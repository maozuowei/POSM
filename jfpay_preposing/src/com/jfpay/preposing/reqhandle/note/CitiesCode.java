 ...
 * 
 */
public class CitiesCode extends ClientReqHandle implements IClientReqHandleService {
	...
	public CommunicationInfo getCommuInfo(HashMap<String, String> map) {
		...
		String parameter = ParseCoreReceiveXml.PROVINCE_CODE + "=" + map.get(ParseCoreReceiveXml.PROVINCE_CODE);
