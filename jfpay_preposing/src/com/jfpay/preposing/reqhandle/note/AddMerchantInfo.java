...
public class AddMerchantInfo extends ClientReqHandle implements IClientReqHandleService{
	...
	public CommunicationInfo getCommuInfo(HashMap<String, String> map) {
		...
		String parameter = "";
		parameter=ParseCoreReceiveXml.PHONE + "=" + map.get(ParseCoreReceiveXml.PHONE) + "&" + 
				ParseCoreReceiveXml.APP_USER + "=" + map.get(ParseCoreReceiveXml.APP_USER)+ "&" + 
						ParseCoreReceiveXml.MERCHANT_NAME + "=" + map.get(ParseCoreReceiveXml.MERCHANT_NAME)+ "&" + 
								ParseCoreReceiveXml.MERCHANT_ADDRESS + "=" + map.get(ParseCoreReceiveXml.MERCHANT_ADDRESS)+ "&" + 
										ParseCoreReceiveXml.MCC_ID + "=" + map.get(ParseCoreReceiveXml.MCC_ID)+ "&" + 
