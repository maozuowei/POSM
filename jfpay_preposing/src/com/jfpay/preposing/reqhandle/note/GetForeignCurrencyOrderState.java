 ...
 *
 */
public class GetForeignCurrencyOrderState extends ClientReqHandle implements IClientReqHandleService{
	...
	public CommunicationInfo getCommuInfo(HashMap<String, String> map) {
		...
		String parameter = "";
		parameter=ParseCoreReceiveXml.ORDER_ID+"="+map.get(ParseCoreReceiveXml.ORDER_ID);
