 ...
 * 
 */
public class ClientUpdate2 extends ClientReqHandle implements IClientReqHandleService {
	...
	public CommunicationInfo getCommuInfo(HashMap<String, String> map) {
		...
		String parameter = ParseCoreReceiveXml.VERSION + "=" + map.get(ParseCoreReceiveXml.VERSION) + "&" + ParseCoreReceiveXml.CLIENT_TYPE + "="
				+ map.get(ParseCoreReceiveXml.CLIENT_TYPE) + "&" + ParseCoreReceiveXml.APP_USER + "=" + map.get(ParseCoreReceiveXml.APP_USER);
