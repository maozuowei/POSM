...
public class GetCouponStoreList extends ClientReqHandle implements IClientReqHandleService{
	...
	public CommunicationInfo getCommuInfo(HashMap<String, String> map) {
		...
		String parameter = "";
		parameter=ParseCoreReceiveXml.ID+"="+map.get(ParseCoreReceiveXml.ID)+"&"
