...
public class GetMerchantTypeList extends ClientReqHandle implements IClientReqHandleService{
	...
	public CommunicationInfo getCommuInfo(HashMap<String, String> map) {
		...
		String parameter = "";
		parameter=ParseCoreReceiveXml.CITYID+"="+map.get(ParseCoreReceiveXml.CITYID)+"&"
				 +ParseCoreReceiveXml.COUPON_NAME+"="+map.get(ParseCoreReceiveXml.COUPON_NAME);
